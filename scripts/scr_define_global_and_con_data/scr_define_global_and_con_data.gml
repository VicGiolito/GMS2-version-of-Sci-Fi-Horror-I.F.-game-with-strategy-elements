function scr_define_global_and_con_data(){
	...
	global.help_instructions_str_ar = [
		...
		"\nCHOOSING CHARACTERS:\n\n",
		"Use the up and down arrow keys to change the currently selected stasis pod.\n\n",
		...
		"\n'O'VERWATCH: If your currently equipped weapon supports over watch fire, you will aim your weapon at a target position on the battlefield and fire upon any enemy that moves into it. Particularly useful when facing off against large swarms of enemies that have a shorter attack range than you.\n",
		...
		"\nA note about sanity in combat: Each character starts with 0 sanity, but once their sanity points reach their maximum value, the character will suffer a mental break down, which manifests itself differently depending upon the character. Your weaker party members may flee, or curl into a fetal position and become useless for awhile; while your more physically imposing security characters will likely become violent, and may even turn against you! Each character will (eventually) regain their composure, and half of their sanity points.\n",
		"\n-------------------------------------\n",
		...
		"\nThe ship is breaking down all around you, presenting a variety of environmental threats which, if not addressed, can escalate until your defeat becomes all but inevitable.\n\tYou can repair or mitigate these hazards by passing CRISIS EVENTS, 'o'perating the station in the ENVIRONMENTAL CONTROL ROOM, or 'u'sing items like the FIRE EXTINGUISHER, WELDING TORCH, or TORQUE WRENCH.\n\tNotably, certain suits like the HAZMAT SUIT and VACUUM SUIT also offer protection against environmental hazards, and certain characters are more resistant to hazard damage than others. Some are even immune to it.\n\tDamage from environmental hazards is triggered both when characters enter a room that contains a hazard, and when they start their turn in a room that contains a hazard.\n",
		$"\nTOXIC GAS: Deals {DOT_HAZARD_DMG_TOXIC_GAS} toxic gas damage. Also spreads to adjacent rooms at the start of each turn if the adjoining door is destroyed.\n",
		$"\nVACUUM: Deals vacuum damage equal to 50% of a character's maximum health. Instantly spreads to all interconnected rooms if the adjoining doors are destroyed, dealing vacuum damage immediately. Note: FIRE and TOXIC GAS hazards are immediately cleared by VACUUM.\n",
		$"\nFIRE: Easily the most dangerous environmental hazard within any structure positioned in the harsh environment of space, deals {DOT_HAZARD_DMG_FIRE} fire damage. Has a {FIRE_SPREAD_THRESHOLD_VAL}% chance of spreading to adjacent rooms with an adjoining door at the start of each turn, regardless of the door state, destroying doors as it spreads. If it breaches the exterior of the structure, you may have another problem to contend with: vacuum exposure!\n\tFair warning, if this happens, your adventure may end VERY suddenly!\n",
		$"\nELECTRICAL CURRENT: Deals {DOT_HAZARD_ELECTRIC_DMG} electrical damage. Deals triple damage to synthetic characters and double damage to cybernetic characters. Organic characters have a 25% of becoming stunned for 1 turn; synthetic and cybernetic characters have 50% chance of becoming stunned for 1 turn. Does not spread to adjacent rooms.\n",
		"\n-------------------------------------\n",
		"\nCRISIS EVENTS:\n",
		"\nYou will periodically be presented with various CRISIS EVENTS which require that you complete a certain objectives within a set period of time, in order to avoid the described catastrophe.\n\tCRISIS EVENTS are semi-randomized but generally increase in difficulty the longer the game progresses, and thus enforce a sort of loose time limit on the game. To best combat CRISIS EVENTS, it is advisable to possess a diverse set of skills among your party members.\n",
		"\n-------------------------------------\n",
		"\nGLOBAL RESOURCES:\n",
		...
		"\nSCRAP: This resource represents metal rubble and debris that can be converted into more useful things like ammunition, droids, items, weapons, armor, etc. It is also used when 'r'epairing droids and synthetic characters.\n",
		...
		"\nADVANCED TECHNOLOGY: The most valuable resource, it is requirement for most of your primary objectives, and therefore a requirement to complete the game. Many room interactions and quest objectives can only be completed by acquiring this resource.\n",		
		"\n-------------------------------------\n"
	];
