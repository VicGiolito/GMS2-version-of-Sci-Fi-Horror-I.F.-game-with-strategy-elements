function scr_define_global_and_con_data(){
	...
	global.help_instructions_str_ar = [
		...
		$"\n'E' or 'END': This will end your turn, triggering enemy movement. Each party member fully restores their movement points and regains +{BASE_AP_REGAIN} ability points. Your party members collectively consume one unit of food, and starving characters lose {STARVING_HP_LOSS} hit point at this point. At the start of the next turn, enemies automatically attack any characters in the same room as them, so long as that character is not currently hidden.\n",
        "\n'Q' or 'QUESTS': View a list of your current objectives. Some of these objectives are global in scope, and completing them is required in order to finish the game; while others pertain to the personal objectives of individual characters. Each character starts the game with their own personal objective, and completing these grants various bonuses, such as new items or abilities.\n",
		"\n'T' or 'TALK': Allows you to talk to one your party members, or a character that is following you, if applicable. Characters may or may not provide you with hints or useful information. Their responses, and the usefulness of their advice, is dependent upon the character, the current global and personal quests available, and the current room the character is standing in. If you are feeling stuck you can try using this command on different characters while they're standing in different rooms, but keep in mind that some characters will consistently provide more useful advice, while others will even mislead you with false information!\n",
		...
		"\n-------------------------------------\n",
		"\nGLOBAL RESOURCES:\n",
		$"\nFOOD: One unit of food is collective consumed by all party members at the start of each new turn. Starving characters lose {STARVING_HP_LOSS} hit point at the start of each new turn.\n",
