...
//I would rather items existed as integers in each room's scavenge array, then have a shit ton of instantiated items around.

function defunct_scr_add_items_to_grid(grid_to_use){
