...
function scr_defunct_position_char_sprite_in_room(room_struct_id, called_from_str){
	
	if is_undefined(called_from_str) {
		throw("scr_position_char_sprite_in_room: called_from_str is undefined, we don't know where this script was called from.");
	}
	else {
		d($"scr_position_char_sprite_in_room was called from {called_from_str}");	
	}
